...
datatable(mai, colnames = c("Tỉnh/Thành phố", "Quận/Huyện", "Phường/Xã", "Tỉ lệ/xã phường", "Tỉ lệ/cả nước", "Kinh độ", "Vĩ độ", "Khoảng cách tới tâm", "STT"))
```
